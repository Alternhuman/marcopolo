...
//int request_for(marco_t mp, char* service, node_t* nodes, int max_nodes, char* exclude[], int exclude_len, int exclude_len, parameter_t* params, int timeout, int retries);
}