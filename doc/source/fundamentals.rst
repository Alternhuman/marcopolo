...
- A :doc:`/fundamentals/marco` instance, bound to each application in need of access to the protocol. It is in charge of creating commands to multicast in the network, and works pretty much like a DNS resolver (through a local socket on 127.0.1.1).
